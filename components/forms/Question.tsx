      ...
      if (tagValue !== "") {
        if (tagValue.length < 2) {
          return form.setError("tags", {
            type: "requried",
            message:
              "Tag must be at least 15 characters long",
          });
        }
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className=" flex w-full flex-col ">
              ...
              <FormDescription className=" body-regular mt-2.5 text-lime-500 ">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className=" flex w-full flex-col ">
              ...
              <FormDescription className=" body-regular mt-2.5 text-lime-500 ">
                Add up to 3 tags to describe what
